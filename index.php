...
$CONFIG = '{"js-ace-fontSize":"16","lang":"en","error_reporting":true,"show_hidden":true,"hide_Cols":true,"calc_folder":false}';

/**
 * File Manager V2.4.5
 * Jakhongir Ganiev | @JahongirGaniyev
 * https://ganiyev.uz
 */
...
$auth_users = array(
    'username' => '$2y$10$WLgbPwxlWkN2HsFK9o91wuRAspRBQxnN3KPNg17VBzhfcOsKRIGLS'
);
...
$default_timezone = 'Asia/Tashkent'; // UTC
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        sleep(1);
        if($use_auth) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && (md5 (sha1($_POST['fm_pwd']))==$auth_users[$_POST['fm_usr']])) {
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                          <object type="image/svg+xml" data="https://ganiyev.uz/robot.svg"></object>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://ganiyev.uz/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Jakhongir Ganiev</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_POST['ajax']) && !FM_READONLY) {
    ...
    if (isset($_POST['type']) && $_POST['type'] == "pwdhash") {
        $res = isset($_POST['inputPassword2']) && !empty($_POST['inputPassword2']) ? md5(sha1($_POST['inputPassword2'])) : '';
        echo $res;
    }
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://ganiyev.uz/" target="_blank" class="app-v-title">File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Jakhongir Ganiev</p>
                        <p>Mail Us: <a href="mailto:ganiyevjahongir03@gmail.com">ganiyevjahongir03[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
